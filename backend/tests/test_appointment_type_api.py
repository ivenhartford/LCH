...
class TestAppointmentTypeList:
    ...
    def test_get_appointment_types_include_inactive(self, authenticated_client, sample_appointment_types):
        """
    ...
    def test_get_appointment_types_ordered_by_name(self, authenticated_client, sample_appointment_types):
        """
        GIVEN appointment types in database
        WHEN GET /api/appointment-types is called
...
class TestAppointmentTypeCreate:
    ...
    def test_create_appointment_type_duplicate_name(self, authenticated_client, sample_appointment_types):
        """
...
class TestAppointmentTypeUpdate:
    ...
    def test_update_appointment_type_not_found(self, authenticated_client):
        ...
        THEN it should return 404 Not Found
        """
        response = authenticated_client.put('/api/appointment-types/99999', json={'name': 'Updated'})
        assert response.status_code == 404
    ...
    def test_update_appointment_type_multiple_fields(self, authenticated_client, sample_appointment_types):
        """
    ...
    def test_update_appointment_type_duplicate_name(self, authenticated_client, sample_appointment_types):
        """
...
class TestAppointmentTypeDelete:
    ...
    def test_hard_delete_appointment_type_non_admin(self, authenticated_client, sample_appointment_types):
        """

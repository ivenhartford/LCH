...
@pytest.fixture
def sample_appointments(authenticated_client, sample_client, sample_patient, sample_appointment_type, sample_staff):
...
class TestAppointmentList:
    ...
    def test_get_appointments_filter_by_client(self, authenticated_client, sample_client, sample_appointments):
        """
    ...
    def test_get_appointments_filter_by_patient(self, authenticated_client, sample_patient, sample_appointments):
        """
    ...
    def test_get_appointments_filter_by_staff(self, authenticated_client, sample_staff, sample_appointments):
        """
    ...
    def test_get_appointments_filter_by_type(self, authenticated_client, sample_appointment_type, sample_appointments):
        """
        ...
        """
        response = authenticated_client.get(f'/api/appointments?appointment_type_id={sample_appointment_type}')
        assert response.status_code == 200
        data = response.json
        assert len(data['appointments']) == 1
    ...
    def test_get_appointments_filter_by_date_range(self, authenticated_client, sample_appointments):
        ...
        response = authenticated_client.get(f'/api/appointments?start_date={start_date}&end_date={end_date}')
        assert response.status_code == 200
...
class TestAppointmentCreate:
    ...
    def test_create_appointment_full(self, authenticated_client, sample_client, sample_patient,
                                    sample_appointment_type, sample_staff):
        """
...
class TestAppointmentUpdate:
    ...
    def test_update_appointment_status_to_confirmed(self, authenticated_client, sample_appointments):
        """
    ...
    def test_update_appointment_status_to_checked_in(self, authenticated_client, sample_appointments):
        """
    ...
    def test_update_appointment_status_to_in_progress(self, authenticated_client, sample_appointments):
        """
    ...
    def test_update_appointment_status_to_completed(self, authenticated_client, sample_appointments):
        """
    ...
    def test_update_appointment_status_to_cancelled(self, authenticated_client, sample_appointments):
        """
    ...
    def test_update_appointment_multiple_fields(self, authenticated_client, sample_appointments, sample_staff):
        """
